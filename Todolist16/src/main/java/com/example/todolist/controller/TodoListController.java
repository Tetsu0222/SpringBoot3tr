...
public class TodoListController {
	...
	public ModelAndView createTodo( ModelAndView mv ) {
		...
		List<Category> categoryList = categoryRepository.findAllByOrderById();
		mv.addObject( "categoryList" , categoryList );	//ここも
	...
	@GetMapping( "/todo/af/delete" )	//添付ファイルの削除
